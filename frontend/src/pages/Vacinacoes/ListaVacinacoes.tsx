...
export const ListaVacinacoes: React.FC = () => {
  ...
  return (
    <MainLayout>
      <DocumentTitle title="Vacinações" />
      <div className="p-6 space-y-6">
            ...
            <button
              onClick={async () => {
                try {
                  ...
                  await exportVacinacoes(filtros);
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="md:col-span-3 relative">
            ...
            <input 
              type="text" 
              placeholder="Buscar por nome da vacina ou CPF..."
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
                  const digits = (localFiltros.vacina || '').replace(/\D/g, '');
                  if (digits.length >= 11) {
                    const next = { ...localFiltros, vacina: '', trabalhadorId: digits };
            ...
            <div className="px-8 py-5 bg-slate-50/50 border-t border-slate-100">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                ...
                <p className="text-sm text-slate-500 font-medium md:order-none">
                  Mostrando{" "}
                  <span className="text-slate-900 font-bold">{vacinacoes.length}</span> de{" "}
