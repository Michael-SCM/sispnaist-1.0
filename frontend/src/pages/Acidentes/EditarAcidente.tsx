    ...
    const carregarAcidente = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          horarioAposInicioJornada: acidente.horarioAposInicioJornada || '',
          tipoAcidente: acidente.tipoAcidente,
          tipoTrauma: acidente.tipoTrauma || '',
          agenteCausador: acidente.agenteCausador || '',
          parteCorpo: acidente.parteCorpo || '',
          ...
          catDataEmissao: formatarDataInput(acidente.catDataEmissao),
          catTipo: acidente.catTipo || '',
          emitenteCat: acidente.emitenteCat || '',
          cidLesao: acidente.cidLesao || '',
          dataObito: formatarDataInput(acidente.dataObito),
