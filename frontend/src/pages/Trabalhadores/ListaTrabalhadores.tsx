      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={async () => {
                const toastId = 'export-trabalhadores';
                try {
                  toast.loading('Exportando trabalhadores...', { id: toastId });
                  await exportTrabalhadores();
                  toast.success('Exportação pronta!', { id: toastId });
                } catch (e) {
                  toast.error('Erro ao exportar trabalhadores', { id: toastId });
                  console.error(e);
                }
              }}
            ...
            <div className="px-8 py-5 bg-slate-50/50 border-t border-slate-100">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                ...
                <p className="text-sm text-slate-500 font-medium md:order-none">
                  Mostrando{" "}
                  <span className="text-slate-900 font-bold">{trabalhadores.length}</span> de{" "}
