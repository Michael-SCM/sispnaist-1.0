...
<button
              onClick={async () => {
                const toastId = 'export-doencas';
                try {
                  toast.loading('Exportando doenças...', { id: toastId });
                  await exportDoencas();
                  toast.success('Exportação pronta!', { id: toastId });
                } catch (e) {
                  toast.error('Erro ao exportar doenças', { id: toastId });
                  console.error(e);
                }
              }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  value={maskCPF(localFiltros.trabalhadorId ? localFiltros.trabalhadorId : '')}
            ...
            <div className="px-8 py-5 bg-slate-50/50 border-t border-slate-100">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                ...
                <p className="text-sm text-slate-500 font-medium md:order-none">
                  Mostrando{" "}
                  <span className="text-slate-900 font-bold">{doencas.length}</span> de{" "}
