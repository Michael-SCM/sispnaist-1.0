...
// Rest of CPFInput, CNPJInput, TelefoneInput, CEPInput, SearchInput remain the same but add help?: string to their interfaces and render {help && <p className="text-gray-500 text-xs mt-1">{help}</p>} after error.
...
// Similar for CNPJInput, TelefoneInput, CEPInput, SearchInput...
