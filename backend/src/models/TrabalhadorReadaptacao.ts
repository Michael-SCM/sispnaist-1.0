...
export interface ITrabalhadorReadaptacaoDocument extends ITrabalhadorReadaptacao {}

const TrabalhadorReadaptacaoSchema = new Schema<ITrabalhadorReadaptacaoDocument>(
  {
