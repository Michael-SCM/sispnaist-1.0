...
const CATALOGO_DADOS: Array<{
  ...
  { entidade: 'agente', itens: [
    ...
    { nome: 'Acidente', ordem: 5 },
    { nome: 'Psicossocial', ordem: 6 },
    { nome: 'Paciente com HIV', ordem: 7 },
    { nome: 'Paciente HBsAg', ordem: 8 },
    { nome: 'Paciente HCV', ordem: 9 },
    { nome: 'Paciente Sífilis', ordem: 10 },
    { nome: 'Desconhecido', ordem: 11 },
    { nome: 'Fonte Descartada', ordem: 12 },
  ]},
  // Causador de Trauma
  ...
  // Tipo de Risco Ocupacional
  { entidade: 'tipoRisco', itens: [
    { nome: 'Ruído', sigla: 'Físico', ordem: 1 },
    { nome: 'Vibração', sigla: 'Físico', ordem: 2 },
    { nome: 'Calor', sigla: 'Físico', ordem: 3 },
    { nome: 'Frio', sigla: 'Físico', ordem: 4 },
    { nome: 'Radiação Ionizante', sigla: 'Físico', ordem: 5 },
    { nome: 'Radiação Não Ionizante', sigla: 'Físico', ordem: 6 },
    { nome: 'Pressão Anormal', sigla: 'Físico', ordem: 7 },
    { nome: 'Umidade', sigla: 'Físico', ordem: 8 },
    { nome: 'Poeira', sigla: 'Químico', ordem: 9 },
    { nome: 'Fumo/Gases', sigla: 'Químico', ordem: 10 },
    { nome: 'Névoa/Neblina', sigla: 'Químico', ordem: 11 },
    { nome: 'Vapor', sigla: 'Químico', ordem: 12 },
    { nome: 'Substância Química', sigla: 'Químico', ordem: 13 },
    { nome: 'Bactéria', sigla: 'Biológico', ordem: 14 },
    { nome: 'Vírus', sigla: 'Biológico', ordem: 15 },
    { nome: 'Fungo', sigla: 'Biológico', ordem: 16 },
    { nome: 'Parasita', sigla: 'Biológico', ordem: 17 },
    { nome: 'Protozoário', sigla: 'Biológico', ordem: 18 },
    { nome: 'Paciente com HIV', sigla: 'Paciente com HIV', ordem: 19 },
    { nome: 'Paciente HBsAg', sigla: 'Paciente HBsAg', ordem: 20 },
    { nome: 'Paciente HCV', sigla: 'Paciente HCV', ordem: 21 },
    { nome: 'Paciente Sífilis', sigla: 'Paciente Sífilis', ordem: 22 },
    { nome: 'Desconhecido', sigla: 'Desconhecido', ordem: 23 },
    { nome: 'Fonte Descartada', sigla: 'Fonte Descartada', ordem: 24 },
    { nome: 'Postura Inadequada', sigla: 'Ergonômico', ordem: 25 },
    { nome: 'Esforço Físico', sigla: 'Ergonômico', ordem: 20 },
    { nome: 'Repetitividade/Monotonia', sigla: 'Ergonômico', ordem: 21 },
    { nome: 'Jornada Extensa', sigla: 'Ergonômico', ordem: 22 },
    { nome: 'Máquina sem Proteção', sigla: 'Acidente', ordem: 23 },
    { nome: 'Ferramenta Inadequada', sigla: 'Acidente', ordem: 24 },
    { nome: 'Eletricidade', sigla: 'Acidente', ordem: 25 },
    { nome: 'Incêndio/Explosão', sigla: 'Acidente', ordem: 26 },
    { nome: 'Animais Peçonhentos', sigla: 'Acidente', ordem: 27 },
    { nome: 'Assédio Moral', sigla: 'Psicossocial', ordem: 28 },
    { nome: 'Assédio Sexual', sigla: 'Psicossocial', ordem: 29 },
    { nome: 'Estresse', sigla: 'Psicossocial', ordem: 30 },
    { nome: 'Síndrome de Burnout', sigla: 'Psicossocial', ordem: 31 },
    { nome: 'Outro', ordem: 99 },
  ]},
