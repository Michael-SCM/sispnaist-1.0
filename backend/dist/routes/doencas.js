...
const doencaController = __importStar(require("../controllers/doencaController.js"));
...
router.post('/', (0, validation_js_1.validateRequest)(validations_js_1.criarDoencaSchema), doencaController.criar);
...
router.put('/:id', (req, res, next) => {
    ...
    next();
}, (0, validation_js_1.validateRequest)(validations_js_1.atualizarDoencaSchema), doencaController.atualizar);
