...
const materialBiologicoController = __importStar(require("../controllers/materialBiologicoController.js"));
...
router.delete('/:id', auth_js_1.adminMiddleware, materialBiologicoController.deletar);
