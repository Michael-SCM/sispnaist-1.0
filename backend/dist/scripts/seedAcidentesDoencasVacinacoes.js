...
function getRandomDate(daysAgo = 365, baseDate) {
...
async function getCatalogoMap() {
    const catalogos = await Catalogo_js_1.default.find({});
    const map = {};
...
function gerarDescricao(causador, trauma, parte) {
...
async function seedAcidentesDoencasVacinacoes() {
    ...
    try {
        ...
        if (mongoose_1.default.connection.readyState === 0) {
            await mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/sispnaist', {
        ...
        const trabalhadores = await Trabalhador_js_1.default.find({});
        ...
        const [acidentesDeletados, materialBiologicoDeletados, doencasDeletadas, vacinacoesDeletadas, afastamentosDeletados] = await Promise.all([
            Acidente_js_1.default.deleteMany({}),
            MaterialBiologico_js_1.default.deleteMany({}),
            Doenca_js_1.default.deleteMany({}),
            Vacinacao_js_1.default.deleteMany({}),
            TrabalhadorAfastamento_js_1.default.deleteMany({}),
        ]);
        ...
        for (let i = 0; i < trabalhadores.length; i++) {
            ...
            try {
                ...
                await Doenca_js_1.default.create({
                ...
                for (let v = 0; v < 2; v++) {
                    ...
                    await Vacinacao_js_1.default.create({
                        trabalhadorId: trabalhador._id,
                ...
                for (let a = 0; a < numAcidentes; a++) {
                    ...
                    const acidente = await Acidente_js_1.default.create({
                        dataAcidente,
                    ...
                    if (ehMaterialBiologico) {
                        try {
                            ...
                            await MaterialBiologico_js_1.default.create({
                    ...
                    if (comAfastamento) {
                        try {
                            ...
                            await TrabalhadorAfastamento_js_1.default.create({
                                trabalhadorId: trabalhador._id,
...
exports.default = seedAcidentesDoencasVacinacoes;
