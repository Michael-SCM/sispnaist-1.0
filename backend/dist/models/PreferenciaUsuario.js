...
const PreferenciaUsuarioSchema = new mongoose_1.Schema({
    usuarioId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true, unique: true },
...
exports.default = mongoose_1.default.model('PreferenciaUsuario', PreferenciaUsuarioSchema);
