...
const ServidorFuncionarioSchema = new mongoose_1.Schema({
    trabalhadorId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Trabalhador', required: true, unique: true },
...
exports.default = mongoose_1.default.model('ServidorFuncionario', ServidorFuncionarioSchema);
