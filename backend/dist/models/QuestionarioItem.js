...
const QuestionarioItemSchema = new mongoose_1.Schema({
    questionarioId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Questionario', required: true, index: true },
...
exports.default = mongoose_1.default.model('QuestionarioItem', QuestionarioItemSchema);
